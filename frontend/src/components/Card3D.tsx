    ...
    <MouseEnterContext.Provider value={[isMouseEntered, setIsMouseEntered]}>
      ...
      >
        <div
          ...
          className={`flex items-center justify-center relative transition-all duration-150 ease-out ${className}`}
          style={{
...
export const CardItem = ({
  ...
  return (
    <div
      ref={ref}
      className={`w-fit transition duration-150 ease-out ${className}`}
      {...rest}
    >
      {children}
    </div>
