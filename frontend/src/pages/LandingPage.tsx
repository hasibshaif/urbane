...
const places = [
  { name: 'Amsterdam', country: 'Netherlands', img: '/images/places/amsterdam-netherlands.jpeg' },
  { name: 'Venice', country: 'Italy', img: '/images/places/venice-italy.jpeg' },
  { name: 'New York', country: 'United States', img: '/images/places/new-york-united-states.jpeg' },
  { name: 'Kiev', country: 'Ukraine', img: '/images/places/kiev-ukraine.jpeg' },
  { name: 'Dhaka', country: 'Bangladesh', img: '/images/places/dhaka-bangladesh.jpeg' },
  { name: 'Bangkok', country: 'Thailand', img: '/images/places/bangkok-thailand.jpeg' },
]
      ...
      <div className="relative z-10 mx-auto min-h-screen max-w-[1080px] px-4 pb-20 pt-8 sm:px-8">
        ...
        <main className="mt-20 flex flex-col gap-16">
          <section className="mx-auto max-w-3xl text-center">
            ...
            >
              ...
              <p className="mx-auto max-w-2xl text-lg text-slate-300">
                Connect with travelers and locals who share your interests. Find experiences, make friends, and explore cities together.
              </p>
          ...
          <section id="destinations" className="space-y-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-slate-300">Connect with travelers and locals in cities around the world</p>
            </div>
            <div className="grid grid-cols-2 gap-6 sm:grid-cols-3">
              {places.map((place, i) => (
                ...
                >
                  <CardContainer className="h-full w-full" containerClassName="h-full w-full">
                    <CardBody className="h-full w-full">
                      <CardItem translateZ="40" className="h-full w-full">
                        <div className="relative h-full w-full overflow-hidden rounded-2xl aspect-[4/3]">
                          <CardItem translateZ="80" rotateX="5" className="absolute inset-0">
                            <img src={place.img} alt={`${place.name}, ${place.country}`} className="h-full w-full object-cover" />
                          </CardItem>
                          <div className="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/20 to-transparent" />
                          <CardItem translateZ="120" translateY="-10" className="absolute bottom-0 left-0 right-0 p-4">
                            <h3 className="font-display text-lg font-semibold text-white">{place.name}</h3>
                            <p className="text-sm text-slate-300">{place.country}</p>
                          </CardItem>
                        </div>
                      </CardItem>
                    </CardBody>
          ...
          <section className="mx-auto max-w-2xl text-center">
            ...
            >
              ...
              <p className="text-slate-300">
                We match you with like-minded travelers based on your interests, travel style, and location. Start connecting today.
              </p>
              <Link
                to="/signup"
                className="inline-flex items-center gap-2 rounded-full bg-cyan-400 px-6 py-3 text-sm font-semibold text-slate-950 shadow-glow transition hover:bg-cyan-300"
        ...
        <footer className="mt-16 flex flex-col gap-4 border-t border-white/10 pt-6 text-sm text-slate-400 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="mailto:hello@urbane.app" className="hover:text-white">Contact</a>
          </div>
        </footer>
      </div>
    </div>
